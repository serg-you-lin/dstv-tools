...
from dstv_tools.utils.drawers import calculate_slot_points
...
class ProfileDXFExporter:
    ...
    def _add_text(self, position: Tuple[float, float], text: str, height: float = 10, layer_name: str = 'Standard'):
        ...
        """
        text_entity = self.modelspace.add_text(text)
        text_entity.dxf.layer = layer_name
        text_entity.dxf.height = height
        text_entity.dxf.style = 'Standard'
        text_entity.dxf.insert = position
        text_entity.dxf.halign = 0  # LEFT
